...
---
## [0.0.48](https://github.com/hedon954/goapm/compare/v0.0.47..v0.0.48) - 2025-12-01

fix some bugs and improve observability and error handling

### ⚙️ Miscellaneous Chores

- **(ci)** set golangci-lint timeout 10min - ([a2deec0](https://github.com/hedon954/goapm/commit/a2deec038dd45437d8c66b1a2a9fede2d23d3746)) - hedon954
- **(ci)** upgrade git-cliff-action to v4 for changelog generation - ([27d9ccb](https://github.com/hedon954/goapm/commit/27d9ccbd6ff547a02a8438afc62ea83f06ab48c7)) - hedon954
- optimize goapm unit tests - ([9f9a88c](https://github.com/hedon954/goapm/commit/9f9a88ce899f2b2bf47ffb786d0644fc91afd792)) - hedon954
- set golangci lint timeout longer - ([ac6c0f4](https://github.com/hedon954/goapm/commit/ac6c0f4f21115eea38e692aee5c4d3b0b8dab3cb)) - hedon954
- upgrade go version and record request url instead of c.FullPath - ([959f4e8](https://github.com/hedon954/goapm/commit/959f4e845d5a1e3879c31074e2b35e84cf27b18b)) - hedon954

### ⛰️ Features

- **(go)** upgrade go version to 1.24.1 - ([90fa62e](https://github.com/hedon954/goapm/commit/90fa62ec601b2dbba272b7c337de0c4449c338d6)) - hedon954

### 🐛 Bug Fixes

- **(ci)** deprecated exportloopref - ([6dea623](https://github.com/hedon954/goapm/commit/6dea623ca8dc649e12fef072be7a060fd02fdc46)) - hedon954

### 🚜 Refactor

- improve observability and error handling - ([f2ca3d2](https://github.com/hedon954/goapm/commit/f2ca3d2c4c49e25fb43e3b67dd330abbfd30dfa6)) - hedon954

### 🧪 Tests

- **(goapm)** add more unit tests - ([030d6bc](https://github.com/hedon954/goapm/commit/030d6bcf2bd856ec33d8599ba3a01c18bacb68a4)) - hedon954

<!-- generated by git-cliff -->

---
## [0.0.47](https://github.com/hedon954/goapm/compare/v0.0.46..v0.0.47) - 2025-03-04
...
- define const to reduce unnecessary dependencies - ([c4d6d83](https://github.com/hedon954/goapm/commit/c4d6d83c711a955f359cfe6d8456ba10a5047a87)) - hedon954

### ⛰️ Features

- **(goapm)** provide more unit tests and use `go-mysql-mocker` and `miniredis` for unit tests to avoid real database dependencies - ([f58f85c](https://github.com/hedon954/goapm/commit/f58f85c2c62d976a10ab8654ad4e2bfeaf604afa)) - hedon954

### 🐛 Bug Fixes

- **(mysql)** make mysql related unit tests passed - ([d4cd546](https://github.com/hedon954/goapm/commit/d4cd546d12de11dbea9cf2a2779ee4b9390a49cd)) - hedon954

<!-- generated by git-cliff -->

---
## [0.0.46](https://github.com/hedon954/goapm/compare/v0.0.45..v0.0.46) - 2025-02-28

fix to default get params from form

### 🐛 Bug Fixes

- **(gin)** default set params with form data - ([ba27ccf](https://github.com/hedon954/goapm/commit/ba27ccf6b5f951ef36aa3a87f4db0f934cb0b9ab)) - hedon954
...
- **(gin)** provide stack in gin panic hooks - ([7b0142b](https://github.com/hedon954/goapm/commit/7b0142b8960bdfbcd543b8f63de828c7a89455e2)) - hedon954
